...
There is a clear positive correlation. The association between the two increases with the size of the number. Since it is getting close to 1, we can see there is a slight correlation between the two. 
